import { IQueryConfig, IQueryParams, IQueryResult, PrismaCountArgs, PrismaFindManyArgs, PrismaModelDelegate, PrismaNumberFilter, PrismaStringFilter, PrismaWhereConditions } from "../shared/interface&types"
...
export class QueryBuilder<T, TWhereInput = Record<string, unknown>, TInclude = Record<string, unknown>> {
    ...
    where(conditions: TWhereInput): this {
        ...
        this.countQuery.where = this.deepMarge(this.countQuery.where as Record<string, unknown>, conditions as Record<string, unknown>);
